    ...
    return MaterialApp(
      ...
      routes: {
        '/login': (ctx) {
          ...
          return LoginPage(initialArg: arg is String ? arg : null);
        }
      },
    );
  }
...
class LoginPage extends StatefulWidget {
  ...
  const LoginPage({super.key, this.initialArg});
  @override
...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    // Respect optional initial argument from routes ("email" | "phone")
    final widgetArg = widget.initialArg;
    if (widgetArg == 'phone') { 
